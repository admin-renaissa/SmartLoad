...
export type StreamEventType = 'trace' | 'delta' | 'tool_call' | 'tool_result' | 'usage' | 'error' | 'done';
...
export interface IssaClient {
    chatStream(req: ChatRequest, onEvent: (ev: StreamEvent) => void): Promise<void>;
...
export declare const CREDIT_CLASS_WEIGHTS: Record<CreditClass, number>;
