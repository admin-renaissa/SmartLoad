 ...
 */
export type AppKey = 'renbooks' | 'renexus' | 'renorc' | 'renovax' | 'creator' | 'renaura' | 'smartload';
export type AddonKey = 'smartload';
export type SuiteRole = 'org_owner' | 'org_admin' | 'org_member' | 'org_billing' | 'org_readonly';
...
export type AuthErrorCode = 'oidc_invalid_state' | 'oidc_pkce_failed' | 'oidc_token_invalid' | 'oidc_entitlement_missing' | 'oidc_addon_missing' | 'oidc_org_mismatch' | 'oidc_user_unmapped' | 'oidc_client_misconfigured' | 'oidc_jwks_unavailable';
export declare class RenverseAuthError extends Error {
    code: AuthErrorCode;
...
export interface OidcClient {
    ...
    logout(req: unknown, res: unknown, opts?: {
        rpInitiated?: boolean;
    }): Promise<void>;
